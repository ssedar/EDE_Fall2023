...
PeterPaul.chem.nutrients <- read.csv("~/EDE_Fall2023/Data/Processed/NTL_LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv", stringsAsFactors = TRUE)
...
4. **Residuals vs. Leverage.** This graph will display potential outliers. The values that fall outside the dashed red lines (Cook's distance)
title: "7: Part 1 - Generalized Linear Models"
author: "Environmental Data Analytics | John Fay and Luana Lima | Developed by Kateri Salk"
date: "Fall 2023"
output: pd are outliers for the model. Watch for drastic departures of the solid red line from horizontal - this is a sign of a poor model fit.
