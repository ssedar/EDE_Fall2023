...
PeterPaul.chem.nutrients <- 
  read.csv("~/EDE_Fall2023/Data/Processed/NTL_LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv", stringsAsFactors = TRUE)
PeterPaul.chem.nutrients.gathered <-
  read.csv("~/EDE_Fall2023/Data/Processed/NTL-LTER_Lake_Nutrients_PeterPaulGathered_Processed.csv", stringsAsFactors = TRUE)
EPAair <- read.csv("~/EDE_Fall2023/Data/Processed/EPAair_O3_PM25_NC1819_Processed.csv", stringsAsFactors = TRUE)
...
* axis label colors default is black/gray
