...
processed_data = "~/EDE_Fall2023/Data/Processed/Processed_KEY"
...
ggplot(PeterPaul.chem.nutrients,
       aes(x=month))+
    geom_bar()
#using freqplot to count the number of months... hard to read as-is
#didnt change original dataset, just here for this specific analysis 
...
ggplot(PeterPaul.chem.nutrients,
    ...
    geom_bar()+
    scale_x_discrete(name="Month", drop=FALSE)#use discrete because we defined month as a factor... can also remove month label

#Tidy up the code -- everytime you have a parenthesis hit return
ggplot(PeterPaul.chem.nutrients,
       aes(x=factor(month, 
                    levels=1:12, 
                    labels=month.abb)))+
...
# 1. 
# Plot surface temperatures by day of  year. #filter dataset depth == 0
# Color your points by year, and facet by lake in two rows.
# Change the ylab name

PeterPaul.chem.nutrients.surface <- filter(PeterPaul.chem.nutrients, depth == 0)

ggplot(PeterPaul.chem.nutrients.surface,
